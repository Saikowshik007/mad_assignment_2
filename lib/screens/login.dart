...
import 'package:mad_assignment_2/screens/home.dart';
import 'package:mad_assignment_2/screens/register.dart';
                    ...
                    child:Row(
                      ...
                      children: <Widget>[
                        SignInButton.mini(buttonType: ButtonType.google,
                            onPressed: () {Authentication().signInWithGoogle().then((value) => MaterialPageRoute(builder:(context)=>Home()));}),
                        SignInButton.mini(buttonType: ButtonType.facebook, onPressed: (){Authentication().signInWithFacebook();}),
                        SignInButton.mini(buttonType: ButtonType.mail, onPressed:(){_displayEmailInputDialog(context);}),
                        IconButton(onPressed: (){Authentication().anonymous();},iconSize: 45.0, icon: Icon(Icons.account_circle)),
                        IconButton(onPressed: (){_displayPhoneTextInputDialog(context);},iconSize: 45.0, icon: Icon(Icons.call_rounded),color: Colors.blue,),
                        //SignInButton.mini(Icons.question_answer, onPressed: (){Authentication().anonymous();}),
